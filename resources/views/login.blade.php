    ...
    <div class="container">
      ...
      <div class="inner" style="margin-top:7%;margin-bottom:0%;color:white;margin-bottom:40px;">
        ...
        <form action="{{route('login')}}" role="form" method="POST">
            ...
            <input type="text" placeholder='Username' class="input" style="color:white;" name="txtUsername" autofocus="" /><br>
            <label><span class="glyphicon glyphicon-lock"></span></label>

            <input type="password" placeholder="password" class="input" style="color:white;" name="txtPassword"/><br>
