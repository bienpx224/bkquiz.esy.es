...
<div id="sport" class="col-md-9" style="float:right">
    <div class="panel panel-default">
      <div class="panel-heading" style="background-color:#337AB7; color:white;">
        <h2 style="margin-top:0px; margin-bottom:0px;">Thể loại Thể dục thể thao </h2>
      </div>

      <div style="background-color: #d1e1ee;" class="panel-body">

@foreach($topicsSport as $tp)
        <!-- item -->
    <div class="row-item row" >
      <div style="padding-left: 10%;">
            <h3>
              <a href="test/dotest/{{$tp->test_id}}">{{$tp->name}}</a>
