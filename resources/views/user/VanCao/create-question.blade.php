...
@section('content')
  	<div id="main" style="margin:5%;color:white;">
...
<style type="text/css">
  textarea{
    width: 70%;
          ...
          <a href="{{route('getHome')}}"><button type="button" class="btn btn-success" style="background-color:#deffad;color:black;">Done. Back to home<span class="glyphicon glyphicon-home" style="padding-left:10px;padding-right:10px;"></button></a>
				</form>
  			</div>
  		</div>
  	</div>
